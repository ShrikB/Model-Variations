...
print("The softmax action function was use for the output layer because we're looking for a probability distrubution result to classify a target") #5 points
...
print("The size of the first hidden layer is 300. None means the batch size is variable.\
The total number of parameters of the first hidden layer is 235500, which refers to the number of weights & biases") #8 points
model.summary()
...
model.compile(optimizer='sgd', loss=keras.losses.SparseCategoricalCrossentropy()) #8 points

# Research then explain what is an epoch in machine learning.
print("An epoch is both a forward and backward pass of a data/training set") #6 points
